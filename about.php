...
<section class="stock-shell px-4 py-14 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 grid gap-6 lg:grid-cols-3">
        <?php foreach ([['fa-bullseye','เป้าหมายของระบบ','ช่วยให้ลูกค้าค้นหาช่างภาพที่เหมาะกับงานในเชียงรายได้เร็วขึ้น และให้ช่างภาพท้องถิ่นมีพื้นที่แสดงตัวอย่างงานถ่ายภาพ'],['fa-shield-halved','น่าเชื่อถือ','ช่างภาพต้องผ่านการอนุมัติจาก Admin ก่อนแสดงในระบบ พร้อมรีวิวจาก booking ที่เสร็จสิ้นจริง'],['fa-handshake','ติดต่อโดยตรง','ลูกค้าและช่างภาพพูดคุยราคา เงื่อนไข และการชำระเงินกันเองภายนอกเว็บไซต์']] as $item): ?>
